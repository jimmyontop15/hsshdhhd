...
export default function Partners() {
    ...
    return (
      ...
      <img width="400" src="/img/bck4.png" />
            ...
            <a href="https://discord.gg/Q8D4ryh4Er">
                            ...
                            <div>
                                ...
                                <div className="flex items-center mt-1">
                                    <p className="font-normal font-sm">
                                      Chidaya ghar, it offers an ideal platform for developers to share their projects, interact with other developers and sell their projects for money, exploring many projects in different categories and software languages.
                                    </p>
                                </div>     
                            </div>
                        </div>
