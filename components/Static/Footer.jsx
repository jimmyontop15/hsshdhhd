                    ...
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                ...
                                <p className="font-semibold text-xl text-white">Nebula Beatz</p>
                            </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://top.gg/bot/1314619845886611566/vote">
                            ...
                            <div>
                                <a href="https://discord.gg/Q8D4ryh4Er" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Support Server
                                </a>
                            </div>
                            <div>
                                <a href="https://discord.com/api/oauth2/authorize?client_id=1314619845886611566&permissions=277028620608&scope=applications.commands%20bot" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Invite Bot
                                </a>
                            </div>
                        </div>
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://discord.gg/Q8D4ryh4Er">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                            ...
                            <div>
                                <Link href="https://github.com/fxwfz">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
